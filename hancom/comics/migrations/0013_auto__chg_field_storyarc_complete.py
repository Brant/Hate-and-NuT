...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoryArc.complete'
        db.alter_column(u'comics_storyarc', 'complete', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'StoryArc.complete'
        db.alter_column(u'comics_storyarc', 'complete', self.gf('django.db.models.fields.BooleanField')())
