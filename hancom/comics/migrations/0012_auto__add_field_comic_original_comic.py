...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comic.original_comic'
        db.add_column(u'comics_comic', 'original_comic',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comic.original_comic'
        db.delete_column(u'comics_comic', 'original_comic')
