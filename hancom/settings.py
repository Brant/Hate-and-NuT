# Django settings for hancom project.
...
STATIC_URL = '/static/'
# STATIC_URL = 'http://localhost:8888/Sites/hateandnut/hancom/collectstatic/'
...
ROOT_URLCONF = 'hancom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hancom.wsgi.application'
