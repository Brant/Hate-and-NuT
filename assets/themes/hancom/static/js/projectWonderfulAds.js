$(function(){
	...
	if (!($("body").hasClass("single-row-comic-page")) || (myViewport < 748)){
		var smallPlace = $('#siteLogo').parent();
		var asideSmall = $('<aside class="small-header-ad" />').insertAfter(smallPlace);
		$("<hr class='head-ad-break' />").insertAfter(smallPlace);
	...
	if (myViewport >= 748 && !($("body").hasClass("single-row-comic-page"))){
