$(function(){
	...
	if (!$('body').hasClass("nopg") || myViewport < 1024){
		if (!$("body").hasClass("non-comic")){
			...
			$(".comic-footer-row:first").wrapInner("<section id='comicFooterContent' class='comic-footer-content' />");
	...
	var squareAside = $('<aside class="foot-square-ad" />').insertBefore(".foot-shortcuts");
